...
5.- An super-admin user is created with unername admin@admin.com and pass '1234'. You have to change this password on first login. This user won't bee able to be deleted by anyone.
6.- Now you can login and start to add swimmers, events...