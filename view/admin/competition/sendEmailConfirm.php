...
?>
<section class="modal" id="modal-send-competition-email-confirm-<?php echo $competition->getId()?>">
    <div class="modal-content">
        ...
        <main class="modal-main">
            <form class="row ai-center jc-between" method="post" id="send-competition-email-confirm-<?php echo $competition->getId()?>" action="adminCompetition/showCheckEmail/<?php echo $competition->getId()?>" competitionId="<?php echo $competition->getId()?>">
