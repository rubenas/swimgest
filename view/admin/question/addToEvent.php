...
<section class="modal" id="modal-add-question-to-event-<?php echo $event->getId()?>">
    <div class="modal-content">
        <header class="modal-header">
            <h3>Añadir pregunta a <?php echo $event->getName()?>
        ...
        <main class="modal-main">
            <form class="row ai-center jc-between" id="add-question-to-event-<?php echo $event->getId()?>" action="adminQuestion/add" method="post" eventId="<?php echo $event->getId()?>">
